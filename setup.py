...
# ----------------------------------------------------------------------------
# Copyright (c) 2016--, tenatch development team.
#
...
with open('tenatch/__init__.py', 'rb') as f:
...
setup(name='tenatch',
      ...
      author="tenatch development team",
      author_email="cameronmartino@gmail.com",
      maintainer="tenatch development team",
      ...
      #entry_points={
      #    'qiime2.plugins': ['q2-tenatch=tenatch.q2.plugin_setup:plugin'],
      #    'console_scripts': ['tenatch=tenatch.scripts._rpca:RPCA']
      #},
      package_data={},
